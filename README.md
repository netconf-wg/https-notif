...
`git tag draft-ietf-netconf-https-notif-<version>`
...
`git tag draft-ietf-netconf-https-notif-09`

This tag will cause `draft-ietf-netconf-https-notif-10` to be built.
